...
The Serial Port Service contains 2 Characteristics:
 ...
 -# The RX Characteristic: it is a writable characteristic. When the Client device has data to be sent to the Server device, it will write a value into this characteristic.
...
int main(void)
{
  ...
  /* Identify BlueNRG1 platform     aci_hal_set_tx_power_level ring oscillator //AK  */
  ...
  SdkEvalLedOff(LED1);
  //SdkEvalLedOn(LED1);
  /* Configure I/O communication channel:aci_gap_set_discoverable
